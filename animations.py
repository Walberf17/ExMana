...
class Animations:
	...
	def __init__(self , images_idx = 1 , area = (1 , 1) , groups = None , dict_with_image = CHARACTER_IMAGES_DICT):
		"""
		:param images_idx: int
		:param groups: groups to add
		:param dict_to_image: dictionary from where the image will come
		"""
		# print(images_idx , area , groups , dict_with_image)
	...
	def change_size_proportion(self):
		...
		self.rect = pg.Rect(old_pos , calc_proportional_size(self.area))
		if self.images:
